...
namespace Api.Service.Services
{
    public class MunicipioService : IMunicipioService
    {
        ...
        public async Task<MunicipioDtoFull> GetCompleteById(Guid id)
        {
            var entity = await _repository.GetCompleteById(id);
            return _mapper.Map<MunicipioDtoFull>(entity);
        }

        public async Task<MunicipioDtoFull> GetCompleteByIBGE(int codIBGE)
        {
